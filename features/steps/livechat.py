...
def customer_opens_brand_page(context):
    context.livechat_browser = context.BeeDriver(**context.browser_config)
    context.livechat_browser.po.livechat.load()
...
def step_impl(context, resize_action):
    ...
    chat_window = context.livechat_browser.po.livechat.chat_window
...
def step_impl(context):
    start_chat_form = context.livechat_browser.po.livechat.chat_window.start_chat_form
